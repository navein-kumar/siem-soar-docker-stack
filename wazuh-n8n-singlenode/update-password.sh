...
echo "============================================="
echo "  Wazuh Indexer Password Update (Singlenode)"
echo "============================================="

# Find the indexer container
CONTAINER=$(docker compose ps 2>/dev/null | grep -i 'indexer' | awk '{print $1}' | head -1)
...
echo "  docker compose restart wazuh.manager wazuh.dashboard"
